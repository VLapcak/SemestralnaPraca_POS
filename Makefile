...
server: Manazer.o Kocka.o HraciaPlocha.o Hrac.o Figurka.o Tcp_server.o
	g++ Manazer.o Kocka.o HraciaPlocha.o Hrac.o Figurka.o Tcp_server.o -o server -lpthread
